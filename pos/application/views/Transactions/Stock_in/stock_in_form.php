            ...
            <div class="row  ">
                <div class="col-md-4 col-md-offset-4" >
                    <form action="<?= site_url('stock/process')?>" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <!-- <div class="col-md-8">
                                    ...
                                    <input type="text" name="gudang_name" id="gudang_name" value="-" class="form-control" readonly >
                                </div> -->
                                <div class="col-md-8">
                        ...
                        <div class="from-group">
                            <label >Detail *</label>
                            <input type="text" name="detail" id="detail" class="form-control" placeholder="tambahan / re-stock / dll" required  >
                        </div>
                        <div class="from-group">
